...
def test_align_camera_poses():
    ...
    'scale ', s, se1, se2
    print
    'rotation matrx ', R, Re1, Re2
    print
    'translation ', t, te1, te2
...
def test_q_error():
    ...
    a2 = np.rad2deg(a2)
    print
    'Angles: {:f}, {:f}, difference = {:f}'.format(a1, a2, a1 - a2)
    print
    'Error: {:f}'.format(quaternion_angular_error(q1, q2))
...
def test_log_q_error():
    ...
    'Angles: {:f}, {:f}, difference = {:f}'.format(a1, a2, a1 - a2)
    print
    'Error: {:f}'.format(log_quaternion_angular_error(q1, q2))